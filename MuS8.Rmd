...
#plot
plot(x2, pw, type="b", main = "Warte- und Blockierwahrscheinlichkeit für neuen Kunden", xlab = "p = {0.3, 0.7, 0.9}", ylab = "Wahrscheinlichkeit", xlim=c(0.0,1.0))
...
plot(x2, pwAll, type="b", main = "VERSION 2 Warte- und Blockierwahrscheinlichkeit für neuen Kunden", xlab = "p = {0.3, 0.7, 0.9}", ylab = "Wahrscheinlichkeit", xlim=c(0.0,1.0))
```
