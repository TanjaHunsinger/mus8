...
\begin{align*}
x(0)&= ( 1 + \frac{\lambda}{\mu} + \frac{\lambda \cdot \lambda}{2 \cdot \mu \cdot \mu} + \frac{\lambda \cdot \lambda \cdot \lambda}{2 \cdot 2\cdot \mu \cdot \mu \cdot \mu} + \frac{\lambda \cdot \lambda \cdot \lambda \cdot \lambda}{2 \cdot 2 \cdot 2 \cdot 2 \cdot \mu \cdot \mu \cdot \mu \cdot \mu}) ^{-1}\\ 
&= ( 1 + \frac{\lambda}{\mu} + \frac{\lambda^2}{2 \cdot \mu^2} + \frac{\lambda^3}{4 \cdot \mu^3} + \frac{\lambda^4}{16 \cdot \mu^4}) ^{-1}\\
x(1) &= x(0) \cdot \frac{\lambda}{\mu} \\
x(2) &= x(0) \cdot \frac{\lambda^2}{2 \cdot \mu^2} \\
x(3) &= x(0) \cdot \frac{\lambda^3}{4 \cdot \mu^3} \\
x(4) &= x(0) \cdot \frac{\lambda^4}{16 \cdot \mu^4} \\
\end{align*}
...
P(wb) &= x(2) + x(3) + x(4)\\
 &= x(0) \cdot \frac{\lambda^2}{2 \cdot \mu^2} + x(0) \cdot \frac{\lambda^3}{4 \cdot \mu^3} + x(0) \cdot \frac{\lambda^4}{16 \cdot \mu^4} \\
  &= x(0) \cdot ( \frac{\lambda^2}{2 \cdot \mu^2} + \frac{\lambda^3}{4 \cdot \mu^3} + \frac{\lambda^4}{16 \cdot \mu^4} )
\end{align*}
...
\begin{align*}
P(w) &= x(2) + x(3)\\
 &= x(0) \cdot \frac{\lambda^2}{2 \cdot \mu^2} + x(0) \cdot \frac{\lambda^3}{4 \cdot \mu^3} \\
  &= x(0) \cdot ( \frac{\lambda^2}{2 \cdot \mu^2} + \frac{\lambda^3}{4 \cdot \mu^3}  ) \\
P(b) &= x(4) \\
&= x(0) \cdot \frac{\lambda^4}{16 \cdot \mu^4}
\end{align*}
